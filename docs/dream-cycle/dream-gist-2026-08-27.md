...
| ReasoningBank (Google Research): distills generalizable reasoning strategies from success *and* failure into reusable memory — closest external analog to K-I Agent's own ReasoningBank | arXiv:2509.25140 (ICLR 2026) | A |
