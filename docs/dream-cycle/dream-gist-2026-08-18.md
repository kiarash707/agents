...
|---|---|---|---|
| Mem0 | Yes — dense + BM25 + entity-linking, closest comparator to K-I Agent's design | **Default-on** (core `search()`) | B (vendor benchmark, 92.5 LoCoMo/94.4 LongMemEval, Apr 2026) |
