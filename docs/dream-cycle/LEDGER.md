...
Durable cross-night memory for the K-I Agent Nightly Dream Cycle routine
...
| 2026-06-04 | swarm | AdaptOrch +22.9% topology gain gap — K-I Agent fixed-hierarchica | #2289 | - | backfill | n/a | STALE |
| 2026-06-05 | performance | LAMaS 38-46% critical-path gap — K-I Agent fixed-hierarchical mi | #2294 | - | backfill | n/a | STALE |
...
| 2026-06-20 | performance | K-I Agent missing task-completion benchmark vs LangGraph 62% — M | #2427 | - | backfill | n/a | STALE |
...
| 2026-07-22 | intelligence | SCM routed memory 86% LongMemEval exposes K-I Agent CMR gap + ca | #2760 | - | backfill | n/a | STALE |
| 2026-07-23 | memory | OAS budget-operator selection +48% exposes K-I Agent consolidati | #2763 | - | backfill | n/a | STALE |
