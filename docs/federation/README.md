# K-I Agent Federation — User Guide
...
Federation lets two or more K-I Agent installations — your mac, a server, a teammate's laptop — discover each other, exchange signed manifests, and send messages between them with bounded cost and per-peer trust gates. Key properties:
