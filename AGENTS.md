...
## K-I Agent Policy-Governed Concurrent Codex Workflow

K-I Agent is the coordination ledger and policy decision point. Codex agents are
the executors. Coordination records do not write code or run tests.

Use `guidance_brain({ mode: "recommend", task: "..." })` to select K-I Agent
...
5. Execute with Codex workers in isolated scopes; K-I Agent records coordination.
