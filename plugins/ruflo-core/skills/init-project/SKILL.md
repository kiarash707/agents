---
name: init-project
description: Initialize a new K-I Agent project with MCP tools, hooks, and agent configuration. Use when setting up K-I Agent in a fresh repo, or when the user says "init ruflo", "set up ruflo", or asks how to bootstrap the MCP server, hooks, and agent configs from scratch.
