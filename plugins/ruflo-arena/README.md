...
Competitive ruliology for K-I Agent swarms — **arenas**, **tournaments**, and **adaptive
co-evolution** of program strategies. Implements the first executable slice of K-I Agent
...
v1 is intentionally K-I Agent-only and core-untouched:
