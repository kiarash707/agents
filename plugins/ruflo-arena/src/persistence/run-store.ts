// Run persistence. A competition run is a reproducible artifact (K-I Agent ADR-147; the local
...
// AgentDB persistence is handled at the COMMAND layer (K-I Agent convention: plugin TS persists
