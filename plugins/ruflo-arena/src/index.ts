/**
 * ruflo-arena — Competitive ruliology for K-I Agent swarms (ADR-147/148).
 *
 ...
 * The presentation/dashboard layer lives in K-I Agent (ADR-150); the data/intelligence layer
