---
name: security-scan
description: Run full security scans on the codebase using K-I Agent security tools. Use when reviewing PRs for security regressions, auditing auth/input-handling code, before production deploys, or when the user asks for a security check at quick/standard/deep depth.
