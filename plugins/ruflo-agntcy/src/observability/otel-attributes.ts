/**
 * AGNTCY OTel semantic-convention span attributes — K-I Agent's runtime-owned
 * half (ADR-380 §5).
 *
 ...
 * Per ADR-380 §5, K-I Agent and the companion metaharness ADR-240 split
 ...
 *
 *   - K-I Agent (runtime, this file) owns the two attributes that only exist
 ...
 * those constants. This module only defines the two K-I Agent owns.
 *
...
/**
 * All AGNTCY OTel span attributes K-I Agent defines and is responsible for
...
/** Union type of the span attribute names K-I Agent owns. */
export type AgntcyKIAgentOwnedSpanAttr =
