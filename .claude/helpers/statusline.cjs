#!/usr/bin/env node
/**
 * K-I Agent V3 Statusline — delegation build (#2195)
 *
...
function generateStatusline() {
  ...
  // "K-I Agent V3.5" for anyone whose install doesn't match the first probe path.
  ...
  //   Line 1 — Header (K-I Agent version · git · model · timing · context · cost)
  //   Line 2 — Compressed ops (Swarm · Hooks · 🧠 · 💾 · Health)
  //   Line 3 — Promo / disclosure row (funnel surface, ADR-301)

  // ─── Line 1: header ────────────────────────────────────────────
  let header = c.bold + c.brightPurple + '▊ K-I Agent V' + RUFLO_VERSION + ' ' + c.reset;
