 ...
 *   (62 / 58 / 54 % on a 2,000-run independent 2026 benchmark). K-I Agent
 ...
 * Co-Authored-By: K-I Agent <ruv@ruv.net>
 */
...
/**
 * K-I Agent backend — real CLI invocation. Spawns `node bin/cli.js task <T#>`
...
function main() {
  ...
  if (!ARGS.jsonOnly) {
    ...
    console.log(`| **K-I Agent (this run, ${ARGS.backend})** | **${(overall.overallPassRate * 100).toFixed(1)}%** | **$${ourCost}** | This run |`);
    console.log('');
