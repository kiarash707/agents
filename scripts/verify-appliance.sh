#!/bin/sh
# ═══════════════════════════════════════════════════════════════
# K-I Agent RVFA Appliance — Full Capability Verification Suite
# ADR-058: Self-Contained K-I Agent RVF Appliance
#
# Tests ALL 35 categories (95+ checks) to verify every capability
# of the K-I Agent + Claude Flow system works correctly.
#
# Usage:
...
while [ $# -gt 0 ]; do
  case "$1" in
    ...
    --help|-h)
      echo "K-I Agent Appliance Verification Suite"
      echo ""
