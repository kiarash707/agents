...
| README branding | "Claude-Flow" | "K-I Agent" (primary), "claude-flow" (supported) |
| Product name | Claude-Flow | K-I Agent (with claude-flow alias) |
...
└── ruflo/
    ...
    └── README.md           # K-I Agent-branded docs
```
...
4. Update main README.md with K-I Agent branding
...
| README title | "K-I Agent" (PascalCase) |
| CLI binaries | `ruflo` or `claude-flow` (both lowercase) |
| In prose | "K-I Agent" (PascalCase) |
