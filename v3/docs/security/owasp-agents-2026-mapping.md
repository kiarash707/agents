# OWASP Top 10 for Agentic Applications 2026 — K-I Agent control mapping
...
| ✗ | Open — no K-I Agent control yet, tracked for future work |

## Matrix

| ID | Risk | Coverage | K-I Agent controls | Gaps / follow-ups |
|---|---|---|---|---|
