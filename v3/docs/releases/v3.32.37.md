# K-I Agent v3.32.37: Complete Reports, Consistent Initialization

K-I Agent v3.32.37 closes the follow-up defects found while verifying v3.32.36
...
`blocked`. K-I Agent now preserves those valid reports instead of replacing them
...
The K-I Agent wrapper exits successfully for a valid report so CLI and MCP callers
...
- Every tracked shell and Windows hook shim now resolves the same stable K-I Agent
  dist-tag.
