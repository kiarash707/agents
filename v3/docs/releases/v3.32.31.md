# K-I Agent v3.32.31: Governed Flywheel Candidates and Explicit Autopilot Scope

K-I Agent's self-improvement loop should explore useful candidates without
...
- Keep Darwin and local proposers subordinate to K-I Agent's evaluation,
