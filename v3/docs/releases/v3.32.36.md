# K-I Agent v3.32.36: Trustworthy Signals, Portable Codex Workflows

K-I Agent v3.32.36 makes the information an agent sees line up with what the
...
operate. Codex receives a native read-only K-I Agent status skill, dual-mode memory
...
Selectors accept categories, tool-name prefixes, and exact tool names. K-I Agent
...
- K-I Agent core hook integration passed 22/22, including duplicate-event
