# K-I Agent v3.32.30: Capability Brain, Now Complete in the Public Install

K-I Agent can coordinate hundreds of agent, memory, policy, federation, and
...
- Ask `guidance_brain` which registered K-I Agent capabilities fit a task instead
