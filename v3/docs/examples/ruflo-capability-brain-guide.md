# Give Your Coding Agent a Map of K-I Agent
...
K-I Agent v3.32.29 changes that. Its new MCP Capability Brain lets an agent inspect
the running K-I Agent system, see every registered capability, understand the
...
> Before implementing this task, call K-I Agent `guidance_brain` in `recommend`
...
- relevant K-I Agent capability domains;
...
An agent no longer needs a hard-coded list of K-I Agent features. It can discover
...
K-I Agent coordinates and records; the coding agent executes. Learning,
...
benchmark supplies evidence. A policy decision grants authority. K-I Agent keeps
