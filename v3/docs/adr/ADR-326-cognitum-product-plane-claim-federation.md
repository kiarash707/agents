...
**Date**: 2026-07-28  
**Decision owners**: K-I Agent, Cognitum control-plane, Meta-LLM, Comms, and RuView maintainers  
**Related**: ADR-098, ADR-099, ADR-100, ADR-115 through ADR-119,
ADR-324, ADR-325, ADR-327

## Executive decision

Cognitum will integrate K-I Agent claim federation as a shared, zero-trust
...
| Cross-domain policy decisions and delegated grants | K-I Agent ADR-324/325 policy plane |
...
K-I Agent federation verifier in the Cognitum control plane. Several cross-service
...
|---|---|---|
| Critical | Cognitum Functions have no production K-I Agent grant verifier or federation PEP | A federated claim cannot safely authorize a product action |
...
evidence. K-I Agent remains authoritative for its validated memory and policy
...
17. Removing K-I Agent federation providers leaves local product authorities
