...
Two Grade-A papers published July 29, 2026 challenge K-I Agent's current swarm-invocation policy:
...
K-I Agent's CLAUDE.md currently prescribes "AUTO-INVOKE SWARM when task involves 3+ files" and `maxAgents: 8` unconditionally. This policy ignores task-level capability proportionality, leaving 3–7× token efficiency on simple tasks.
