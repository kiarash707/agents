...
K-I Agent v3.6's intelligence router selects between Haiku, Sonnet, and Opus based on a single scalar "complexity percentage" derived from task description length and keyword heuristics. This:
...
Extend K-I Agent's intelligence routing layer with a **4-dimension capability scorer** replacing the current scalar complexity gate.
