...
| [ADR-305](ADR-305-customer-lifecycle-funnel.md) | Customer Lifecycle Funnel (K-I Agent → Cognitum) | Proposed |
...
| [ADR-329](ADR-329-ruflo-capability-brain-mcp-guidance.md) | K-I Agent Capability Brain for MCP Guidance | Accepted |
...
| [ADR-355](ADR-355-swarm-rl-stopping-policy.md) | Reinforcement-Learned Stopping Policy for K-I Agent Swarm Orchestration | Proposed |
