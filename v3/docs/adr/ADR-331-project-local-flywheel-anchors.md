...
K-I Agent's built-in development-history benchmark is selected automatically only
when the target repository identifies itself as K-I Agent/Claude Flow. A foreign
