...
**Date**: 2026-07-28  
**Decision owners**: K-I Agent memory, policy, MetaHarness, Meta-LLM, and Cognitum maintainers  
**Related**: ADR-176, ADR-322, ADR-323, ADR-324, ADR-325, ADR-326,
ADR-327

## Executive decision

K-I Agent may use Cognitum and Meta-LLM services to improve agent development
...
A Cognitum service can propose learning evidence. It cannot write K-I Agent memory
...
When cognition is unavailable, K-I Agent may use its explicit local route if the
...
The first K-I Agent implementation provides:
...
- Operators must configure both product identity and K-I Agent policy.
