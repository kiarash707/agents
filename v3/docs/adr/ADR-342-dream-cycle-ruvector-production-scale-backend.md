...
**Gap identified tonight:** Competitor vector stores (Qdrant, Milvus, Weaviate) are benchmarked at 100M–1B vectors. K-I Agent's only published number is at 20K vectors. The behavior above 20K — particularly QPS, recall, and memory — is unknown and undocumented.
