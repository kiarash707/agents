# ADR-319: K-I Agent announcements via Claude Code `companyAnnouncements` settings
...
1. **Append only.** K-I Agent entries are appended to any existing array; existing user-authored announcements are preserved verbatim.
...
- "🧠 K-I Agent intelligence is learning from your work — `ruflo intelligence stats` to see progress."
...
Cognitum-tagged (~15%):
- "📣 K-I Agent is sponsored by Cognitum — visit cognitum.one to learn more."
