...
> Goal-Oriented Action Planning UI for autonomous AI research workflows. Part of the [K-I Agent](https://github.com/ruvnet/ruflo) platform.
> Live: [goal.ruv.io](https://goal.ruv.io/) · Agents dashboard: [goal.ruv.io/agents](https://goal.ruv.io/agents)

Turn plain-English research goals into executable agent plans. K-I Agent Research applies classic Goal-Oriented Action Planning (GOAP) — A* search through a state space of actions with preconditions and effects — to autonomous AI research, then dispatches the work to live agents you can inspect in real time.

## Highlights

| | |
|---|---|
| 🎯 **Plain-English goals** | Describe an outcome — K-I Agent extracts success criteria, constraints, and implicit preconditions |
