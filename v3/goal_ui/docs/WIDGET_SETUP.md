# K-I Agent Research Widget - Embeddable Research Interface
...
<head>
  ...
  <title>My Site with K-I Agent Research Widget</title>
</head>
<body>
  <!-- Widget Container -->
...
- Review console logs with `[K-I Agent Research]` prefix
