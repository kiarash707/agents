...
## Standalone use (without the K-I Agent CLI)
...
If you're building a K-I Agent plugin that wants neural learning, depend on `@claude-flow/neural` directly rather than reaching into cli internals.
