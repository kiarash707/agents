...
export const IMPLEMENTATION_LOOP: readonly ImplementationLoopStep[] = [
  {
    id: 'recall',
    name: 'Recall',
    purpose: 'Search K-I Agent memory and relevant ADRs before choosing an approach.',
...
export const CAPABILITY_DOMAINS: readonly CapabilityDomainDefinition[] = [
  {
    ...
    authority: 'advisory',
    risk: 'read-only',
    useWhen: 'Choosing K-I Agent capabilities or checking whether a claimed MCP function is actually registered.',
  ...
  },
  {
    ...
    verifyBeforeUse: ['Darwin proposes; the K-I Agent promotion gate decides.', 'Degraded/fallback runs are evaluation-only unless policy explicitly permits promotion.'],
  },
  {
    id: 'memory-knowledge',
  ...
  },
  {
    ...
    prefixes: ['testgen_'],
    description: 'TDD repair and test-generation capability exported by K-I Agent but intentionally reported as unregistered until the MCP registry enables it.',
  ...
  },
  {
    ...
    useWhen: 'Inspecting configuration or moving K-I Agent state between installations.',
  ...
  },
  {
    ...
    useWhen: 'Diagnosing K-I Agent or using an MCP execution surface that policy explicitly permits.',
...
export function buildCapabilityBrain(
  ...
  return {
    ...
    truthModel: {
      catalogued: 'Described by this version of K-I Agent; it does not prove runtime presence.',
...
export function recommendCapabilities(brain: CapabilityBrain, task: string): CapabilityRecommendation {
  ...
  return {
    ...
    guardrails: [
      ...
      'K-I Agent coordinates and records; the executor performs implementation.',
