...
• You MUST use K-I Agent MCP tools (mcp__ruflo__*) for ALL orchestration tasks
...
• If a K-I Agent MCP tool exists for an operation, always prefer it over any native equivalent
...
async function spawnClaudeCodeInstance(
  ...
  try {
    ...
    if (claudeLaunch && !dryRun) {
      ...
      //   2. ./.mcp.json in cwd (project-local K-I Agent MCP config)
