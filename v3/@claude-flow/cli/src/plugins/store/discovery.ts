  ...
  private getDemoPlugins(): PluginEntry[] {
    ...
    return [
      ...
      // Plugin SDK - Unified Plugin SDK for creating plugins
      {
        ...
        description: 'Unified Plugin SDK for K-I Agent V3 - Worker, Hook, and Provider Integration. Create, test, and publish K-I Agent plugins.',
      ...
      // IoT Cognitum - Cognitum Seed device-agent bridge
      {
        ...
        description: 'Cognitum Seed device-agent bridge — treat every Seed as a K-I Agent agent with 5-tier trust scoring, Ed25519 witness chains, mesh networking, and fleet management.',
        version: '1.0.0-alpha.1',
