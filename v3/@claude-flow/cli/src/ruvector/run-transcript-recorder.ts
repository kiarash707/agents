 ...
 * official SWE-bench harness. K-I Agent has NO SWE-bench oracle. Every record
...
/** K-I Agent's cascade tier. haiku → 'cheap' (first tier), sonnet/opus → 'frontier'. */
...
export function recordRunTranscript(args: {
  ...
  model: string;
  /** K-I Agent cascade tier of `model`. */
  tier: RunTier;
