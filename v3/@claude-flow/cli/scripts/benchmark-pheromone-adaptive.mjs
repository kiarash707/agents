 ...
 *
 * This does not repeat the external paper's claims. It measures K-I Agent's local
...
const report = {
  ...
  claimBoundary: 'Synthetic K-I Agent implementation benchmark; external TPSC percentages are not claimed.',
};
