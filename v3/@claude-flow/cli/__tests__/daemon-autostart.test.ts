...
describe('ensureDaemonRunning', () => {
  ...
  it('does not treat a Claude Code-only .claude directory as K-I Agent initialization (#2834)', () => {
    delete process.env.RUFLO_DAEMON_AUTOSTART;
  ...
  it('recognizes only explicit K-I Agent markers, not generic state directories', () => {
