...
describe('Init System', () => {
  ...
  describe('generateClaudeMd', () => {
    ...
    // imperative schema (header "# K-I Agent — Claude Code Configuration", section
    ...
    it('should contain the K-I Agent header', () => {
      const md = generateClaudeMd(DEFAULT_INIT_OPTIONS);
      expect(md).toContain('# K-I Agent');
    });
    ...
    it('should retain the governed workflow in every template', () => {
      for (const template of CLAUDE_MD_TEMPLATES) {
        ...
        expect(md).toContain('## K-I Agent Capability Brain & Implementation Loop');
      }
    });
